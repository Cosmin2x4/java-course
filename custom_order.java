...
public class custom_order {
	...
	System.out.println("Welcome to Java's Cake & Cupcake Shop!"); // Introduce shop and prompt user 
	System.out.println("We make custom cakes with our secret cake batter!"); //to input first name
	...
	firstName = keyboard.nextLine();
      ...
      System.out.println("\n"); // skips a line, ...  after that... TEST CODE
